        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabilityDays = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    AvailabilityHours = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PatientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ToothNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    DoctorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    PainDetails = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DentalLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DentalLogs_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DentalLogs_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DateIssued = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_BillingRecords_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BillingRecordId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentLogs", x => new { x.BillingRecordId, x.Id });
                    table.ForeignKey(
                        name: "FK_PaymentLogs_BillingRecords_BillingRecordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicationItems", x => new { x.PrescriptionId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingRecords_ClinicId",
                table: "BillingRecords",
                column: "ClinicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DentalLogs_DoctorId",
                table: "DentalLogs",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DentalLogs_PatientId",
                table: "DentalLogs",
                column: "PatientId");
